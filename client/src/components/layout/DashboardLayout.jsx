...
export const DashboardLayout = () => {
  ...
  return (
    <div className="relative flex min-h-screen bg-[#F4F5F7] dark:bg-[#0f1117] text-zinc-900 dark:text-zinc-100 antialiased selection:bg-purple-500/20 selection:text-purple-700 dark:selection:text-purple-300">
