        ...
        <input
          ...
          className={`w-full rounded-xl border px-3.5 py-2.5 text-xs sm:text-sm text-zinc-900 dark:text-zinc-100 placeholder:text-zinc-400 dark:placeholder:text-zinc-500 transition-all duration-200 focus:outline-none ${
            error
              ...
              : 'border-black/[0.08] bg-black/[0.025] hover:border-black/[0.14] hover:bg-black/[0.035] focus:bg-white focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/15 dark:border-white/[0.09] dark:bg-white/[0.05] dark:hover:border-white/[0.15] dark:hover:bg-white/[0.07] dark:focus:bg-zinc-900/90 dark:focus:border-emerald-400 dark:focus:ring-emerald-400/20'
